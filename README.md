...
В игре реализована система 'двух шкатулок'. Т.е. игрок при угадывании трёх букв подряд имеет право выбрать 'одну шкатулку', которая может оказаться пустой, либо содержать в себе 2000 очков.<br>
